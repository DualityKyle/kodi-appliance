...
install_system () {
    ...
    BASE_PACKAGES=('base' 'linux' 'linux-firmware' 'networkmanager' 'iw' 'pacman-contrib' 'bash-completion' 'tree' 'sudo' 'nano' 'e2fsprogs' 'neofetch' 'openssh' 'wget' 'man-db' 'man-pages' 'texinfo' 'git' 'ufw')
